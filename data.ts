...
export const data: Array<IData> = [
    {
        ...
        products: [
            ...
            },
            {
                ...
                description: "Бюджетный Натяжной потолок с плинтусом или вставкой, которая закрывает примыкание профиля к стене. Быстрый монтаж, можно устанавливать любое освещение. Хорошо герметизирует внутренее пространство от попдание влаги, за счет специальной вставки.",
